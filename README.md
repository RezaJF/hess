...
specifies the name of the output file. For step 2, HESS has several
additional flags: `--lambda_gc` allows users to specify their own
genomic control factor to re-inflate the summary statistics;
